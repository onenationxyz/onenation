...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // Sticky Mobile nav

var scrollThreshold = 100;

window.onscroll = function () {
  if (window.pageYOffset > scrollThreshold) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#mobile_nav").addClass("ons-sticky");
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#mobile_nav").removeClass("ons-sticky");
  }
};
...
module.exports = __webpack_require__(/*! /Users/sylvain/onenationxyz/onenation/projects/website/src/assets/js/app.js */"./src/assets/js/app.js");
